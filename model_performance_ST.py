...
features = [['AI388', 'AOD550(MODIS)', 'Haer_t1',\
            'vza', 'raa', 'sza', 'As', 'Ps',\
              'lat', 'sin_lon', 'cos_lon', 'sin_doy', 'cos_doy'],
...
expNames = ["%s_%i-layer_%i-neuron" % ('DNN_AAOD_train_ST2', 4, 2**6), \
            "%s_%i-layer_%i-neuron" % ('DNN_AAOD_train_ST3', 5, 2**6)]
titles = ['(a) DNN-F13', '(b) DNN-F14'] 
...
plt.savefig(figdir + 'Model_performance_ST.png', dpi = 300, transparent = True)
